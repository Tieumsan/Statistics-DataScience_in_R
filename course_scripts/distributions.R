...
#load in the data 
bihar_data <- read_csv("../14.310 - Data Analysis in Social Science/Datasets/Bihar_sample_data.csv")
...
us_data <- read_csv("../14.310 - Data Analysis in Social Science/Datasets/US_sample_data.csv")
...
ggplot(bihar_adult_females_trunc, aes(height_cm))+
  geom_histogram(fill="blue", color="darkblue" )+
  geom_histogram(data=us_adult_females_trunc, fill="red", color="darkred" )
